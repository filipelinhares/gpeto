...
var help =  function () {
  var message = [
    ...
    chalk.cyan.bold('      ➜ install        ') + chalk.blue('Install some component to the gpeto\'s folder'),
    chalk.cyan.bold('      ➜ uninstall      ') + chalk.blue('Uninstall some component to the gpeto\'s folder'),
    '                        ',
    chalk.italic('List of available flags:'),
    chalk.cyan.bold('      ➜ --out          ') + chalk.blue('Specify a folder to install each component'),
  ].join('\n')
  console.log(message);
  process.exit();
};
