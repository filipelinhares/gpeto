...
var help =  function () {
  var message = [
    ...
    chalk.cyan.bold('      ➜ add            ') + chalk.blue('Add a folde of components to the gpeto\'s folder'),
    chalk.cyan.bold('      ➜ install        ') + chalk.blue('Install saome package to the gpeto\'s folder'),
    '                        ',
